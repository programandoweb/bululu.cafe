...
#sudo docker run -d --name front-landing-inventory -p7201:3000 --restart=always programandoweb/evolve:front-landing-inventory
#sudo docker stop front-landing-inventory
#sudo docker rm front-landing-inventory
